...
/*
 * The section itself, and what it keeps, are shared with the Adjust screen;
 * see resources/js/adjust.js. What stays here is what only a new entry has:
 * the party and the side can change under it, and Reset puts it back.
 */
...
const adjust = useAdjust({
    ...
    partyId: () => selected.value?.id ?? null,
